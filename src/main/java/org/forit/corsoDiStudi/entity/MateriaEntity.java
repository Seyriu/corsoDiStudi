...
@Table(name = "materia")
@NamedQueries({
  @NamedQuery(name = "materia.selectAll",
          query = "SELECT m from MateriaEntity m Order by m.nome")
})
public class MateriaEntity implements Serializable {
  ...
  public MateriaEntity(long id, String nome) {
    this.id = id;
    this.nome = nome;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final MateriaEntity other = (MateriaEntity) obj;
    if (this.id != other.id) {
      return false;
    }
  ...
  public String toString() {
    return "MateriaEntity{" + "id=" + id + ", nome=" + nome + '}';
  }

...
public class VotoEntity implements Serializable {
    ...
    @Column(name = "ID_MATERIA", unique = false, nullable = false)
    private long idMateria;

    @Column(name = "ID_STUDENTE", unique = false, nullable = false)
    private long idStudente;

    @ElementCollection()
    @CollectionTable(name = "voto_x_prof", joinColumns = @JoinColumn(name = "id_voti"))
    private List<VotoPerProfessoreEntity> professori = new ArrayList<>();
    ...
    public List<VotoPerProfessoreEntity> getProfessori() {
        return professori;
    }

    public void setProfessori(List<VotoPerProfessoreEntity> professori) {

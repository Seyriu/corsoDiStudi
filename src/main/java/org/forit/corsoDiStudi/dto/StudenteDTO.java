...
public class StudenteDTO {
  ...
  public TassaDTO getTassa() {
    return tassa;
  }

  public void setTassa(TassaDTO tassa) {
    this.tassa = tassa;
  }
  ...
  public String toString() {
    return "StudentiDTO{" + "id=" + id + ", nome=" + nome + ", cognome=" + cognome + ", dataNascita=" + dataNascita + ", codiceFiscale=" + codiceFiscale + ", matricola=" + matricola + ", mail=" + mail + ", tasse=" + tassa + ", voti=" + voti + '}';
  }
